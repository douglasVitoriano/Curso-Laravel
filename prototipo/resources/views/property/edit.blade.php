...
<div class="container my-3">
    ...
    <form action="<?= url('/imoveis/update', ['id' => $property->id]); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <input title="text" name="title" id="title" value="<?= $property->title; ?>" class="form-control">
        </div>
        ...
        <div class="form-group">
            ...
            <input title="text" name="rental_price" id="rental_price" value="<?= $property->rental_price; ?>" class="form-control">
        </div>

        <div class="form-group">
            <label for="sale_price">Valor de Compra</label>
            <input title="text" name="sale_price" id="sale_price" value="<?= $property->sale_price; ?>" class="form-control">
        </div>
